...
\hline
-20036 & pkg\_lekcje & Przedmiot grupowy nie może być prowadzony jako lekcja indywidualna \\
\hline
-20037 & pkg\_lekcje & Przedmiot indywidualny nie może być prowadzony jako lekcja grupowa \\
\hline
-20038 & pkg\_oceny & Próba wystawienia oceny z przedmiotu uczniowi grającemu na innym instrumencie \\
\hline
-20040 & pkg\_lekcje & Lekcja zaplanowana na weekend (sobota/niedziela) \\
\hline
\end{tabular}
...
\begin{itemize}[nosep]
    ...
    \item \textbf{Weekend (sobota):} Lekcja indywidualna na sobotę → błąd -20040
    \item \textbf{Weekend (niedziela):} Lekcja grupowa na niedzielę → błąd -20040
\end{itemize}
