...
**Mój tydzień:**
- Mam 15 uczniów indywidualnych (po 2 lekcje = 30 lekcji tygodniowo)
- To jest ~20 godzin samych lekcji (młodsze klasy 30min, starsze 45min)
- Plus: przygotowanie, przerwy, dokumentacja = ~26h w szkole
...
|------|------------|--------------|---------|
| Kowalska | fortepian | kształcenie słuchu | 16 |
| Nowak | fortepian | - | 15 |
| Wiśniewski | skrzypce | orkiestra | 14 |
| Kamiński | skrzypce | - | 12 |
| Zielińska | flet | kształcenie słuchu | 12 |
| Lewandowski | gitara | - | 13 |
| Wójcik | gitara | - | 10 |
| Dąbrowski | perkusja | - | 7 |
| Szymański | fortepian | - | 4 |
| Jankowska | - | rytmika | - |
| Mazur | - | audycje, chór | - |
| Krawczyk | - | orkiestra, kształcenie słuchu | - |

**Razem: 12 nauczycieli, ~100 uczniów**
...
- 2× fortepian (popularne)
- 2× skrzypce
- 1× gitara
- 1× flet
- 1× perkusja
+ 2× nauczyciele przedmiotów grupowych
---
RAZEM: 10-12 nauczycieli
```
...
|------------|---------|---|-------------|----------------|
| Fortepian | 35 | 35% | Kowalska, Nowak | Chór |
...
45. Egzamin semestralny: każdy uczeń zdaje **na koniec semestru**.
46. Egzamin z instrumentu przed **komisją 2 nauczycieli**.
47. Komisja musi składać się z **2 różnych osób** (trigger).
48. Uczeń gra **z pamięci** program przygotowany przez semestr.
49. Ocena z egzaminu: 1-6 (decyduje o promocji).
50. Egzamin to rekord w tabeli LEKCJE z typ='egzamin'.

---

## 3.11 OCENY

51. Skala polska: **1, 2, 3, 4, 5, 6**.
52. Oceny bieżące: wystawiane przez nauczyciela po lekcjach.
53. Ocena powiązana z uczniem, nauczycielem i **przedmiotem** (REF).
54. Obszary oceny: technika, interpretacja, postępy, teoria, słuch.
55. Ocena semestralna: średnia ocen bieżących + egzamin.
56. Ocena z instrumentu **decyduje o promocji** do następnej klasy.

---

## 3.12 PLANOWANIE LEKCJI (HEURYSTYKA)

57. Plan układamy **na cały semestr z góry**.

58. **KOLEJNOŚĆ PLANOWANIA:**
...
59. **PRZY DODAWANIU NOWEGO UCZNIA:**
...
| 7 | LEKCJE | harmonogram + egzaminy + REF przedmiot | 250-350/tydzień |
| 8 | OCENY | oceny bieżące i semestralne | 800+/semestr |
...
OCENY ── REF ──→ UCZNIOWIE
      ── REF ──→ NAUCZYCIELE
      ── REF ──→ PRZEDMIOTY (opcjonalnie)
```

---

# CZĘŚĆ 6: CO MUSI DZIAŁAĆ NA DEMO
...
5. **Wstaw ocenę dla ucznia**
   → Nauczyciel → uczeń → obszar → wartość 1-6

6. **Stwórz egzamin**
   → Komisja 2 nauczycieli (różnych!) → data → sala
