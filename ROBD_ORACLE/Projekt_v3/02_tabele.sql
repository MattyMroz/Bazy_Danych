...
-- Ograniczenie: min 5 lat (trigger)
-- ============================================================================
...
-- Ograniczenia:
--   - Godziny 08:00-20:00
--   - Tylko dni robocze (trigger)
--   - Dzieci <15 lat: 14:00-19:00 (trigger)
--   - Nauczyciel max 6h/dzien (trigger)
--   - Uczen max 2 lekcje/dzien (trigger)
--   - Brak konfliktow sal/nauczycieli/uczniow (triggery)
-- ============================================================================
...
7. t_ocena_postepu  - oceny (2x REF)
