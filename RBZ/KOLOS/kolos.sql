...
-- Tworzenie lokalnego usera NORTHWIND musi byc wykonane w PDB, a nie w CDB$ROOT.
SELECT SYS_CONTEXT('USERENV', 'CON_NAME') AS con_name FROM dual;
ALTER SESSION SET CONTAINER = PDB;
SELECT SYS_CONTEXT('USERENV', 'CON_NAME') AS con_name FROM dual;

CREATE USER northwind IDENTIFIED BY "12345";
GRANT CREATE SESSION, CREATE TABLE, CREATE SEQUENCE, CREATE VIEW TO northwind;
