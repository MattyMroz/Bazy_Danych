...
-- (w systemie Windows - skrót do Net Manager można odnaleźć w zasobie:  C:\ProgramData\Microsoft\Windows\Start Menu\Programs\Oracle - OraDB18Home2\Configuration and Migration Tools )
...
-- Etap 1:
-- Jeżeli nie ma SQLDeveroper - to pobrać z zasobu: \\wenus\zadania\pd - i przegrać do założonego na dysku C: katalogu ORACLE
-- Następnie dokonać konfiguracji SQL DEVELOPER ORACLE:

-- IP: 212.51.216.169
-- PORT: 1421
-- SID pd25

--- połączyć się i napisać zapytanie

select to_char(SYSDATE, 'YYYY-MM-DD:HH24:Mi') from dual;


-- ETAP 2: (praca samodzielna)
-- Przeprowadzić konfigurację  ORACLE i napisać to samo zapytanie w SSMS
