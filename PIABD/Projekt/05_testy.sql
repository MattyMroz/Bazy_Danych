...
-- ============================================================================
-- 9. TESTY UPRAWNIEŃ (do filmiku - logowanie jako różni użytkownicy)
-- ============================================================================

-- UWAGA: Te testy wykonaj po zalogowaniu się jako odpowiedni użytkownik!

-- 9.1 Test jako Guest (tylko widok)
-- Login: Guest, Password: Guest, Database: CompanyDB
-- Powinno działać:
-- SELECT * FROM crunchbase.vw_CompanyOverview;
--
...
-- 9.2 Test jako Emp (procedury)
-- Login: Emp, Password: Emp, Database: CompanyDB
-- Powinno działać:
-- EXEC crunchbase.UpsertCompany @mongo_id='test', @name='Test', @permalink='test';
-- SELECT crunchbase.GetTotalFunding(1);
--
-- Powinno NIE działać (brak dostępu do tabel):
-- SELECT * FROM crunchbase.Company;

-- 9.3 Test jako Admin (pełne uprawnienia)
-- Login: Admin, Password: Admin, Database: CompanyDB
