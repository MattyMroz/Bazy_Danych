...
Baza danych składa się z \textbf{19 tabel} zorganizowanych w schemacie \texttt{crunchbase}. Tabele można podzielić na następujące grupy logiczne:
...
\textbf{Opis funkcjonalny:} Przechowuje informacje o rundach finansowania firm -- typ rundy (seed, Series A, B, C...), kwotę, walutę, datę.
...
W obecnej wersji bazy danych \textbf{nie zdefiniowano triggerów}. Integralność danych jest zapewniona przez:
\begin{itemize}[noitemsep]
...
\begin{itemize}[noitemsep]
    \item[$\checkmark$] 19 tabel z pełną strukturą więzów integralności
...
\hline
01\_struktura.sql & Tworzenie bazy danych, schematu i wszystkich 19 tabel z ograniczeniami \\
\hline
